...
PackageName: GitMap
PackageUrl: https://github.com/alimtvnetwork/gitmap-v5
License: MIT
LicenseUrl: https://github.com/alimtvnetwork/gitmap-v5/blob/main/LICENSE
...
- name: Publish to Winget
  ...
  run: |
    wingetcreate update AliMTVNetwork.GitMap \
      ...
      --urls "https://github.com/alimtvnetwork/gitmap-v5/releases/download/${{ github.ref_name }}/gitmap-${{ github.ref_name }}-windows-amd64.zip" \
