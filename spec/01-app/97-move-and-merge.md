...
gitmap merge-right ./gitmap-v4 https://github.com/alimtvnetwork/gitmap-v4 -y
...
```
  [mv] resolving LEFT  : ./gitmap-v4 (folder, exists)
  ...
  [mv]   commit 9a3c1e2 "gitmap mv from ./gitmap-v4"
  [mv] pushing RIGHT ...
  [mv]   push OK
  [mv] done
```
