...
gitmap merge-right ./gitmap-v5 https://github.com/alimtvnetwork/gitmap-v5 -y
...
```
  [mv] resolving LEFT  : ./gitmap-v5 (folder, exists)
  [mv] resolving RIGHT : https://github.com/alimtvnetwork/gitmap-v5
  [mv]   -> mapped to working folder: ./gitmap-v5
  ...
  [mv]   commit 9a3c1e2 "gitmap mv from ./gitmap-v5"
  [mv] pushing RIGHT ...
  [mv]   push OK
  [mv] done
```
