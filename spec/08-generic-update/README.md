...
See how all specs connect: [`diagrams/unified-architecture.mmd`](diagrams/unified-architecture.mmd)

## Self-Update Flow Diagram

See the Mermaid diagram: [`diagrams/self-update-flow.mmd`](diagrams/self-update-flow.mmd)
