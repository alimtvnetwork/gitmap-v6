        ...
        <div>
          ...
          <div className="bg-card border border-border rounded-lg p-4 mb-4">
            <div className="space-y-2 font-mono text-sm">
              ...
              <div className="flex items-center gap-3">
                <span className="bg-primary/10 text-foreground border border-primary/20 dark:bg-primary/25 dark:text-background px-3 py-1 rounded">2. Config file</span>
                <span className="text-muted-foreground">→ ./data/config.json</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="bg-primary/20 text-foreground border border-primary/30 dark:bg-primary/30 dark:text-background px-3 py-1 rounded font-semibold">3. CLI flags</span>
