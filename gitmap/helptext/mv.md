...
**Output:**
    ...
    [mv] resolving LEFT : ./gitmap-v5 (folder)
    [mv] resolving RIGHT : ./gitmap-v5 (folder)
    [mv] copying files LEFT -> RIGHT (excluding .git/) ...
    [mv]   copied 142 files
    [mv] deleting LEFT (./gitmap-v5) ...
    [mv]   deleted
    [mv] done

### Example 2: Move a local folder into a remote repo (clone + push)

    gitmap mv ./gitmap-v5 https://github.com/owner/gitmap-v5

**Output:**

    [mv] resolving RIGHT : https://github.com/owner/gitmap-v5
    [mv]   -> mapped to working folder: /work/gitmap-v5
    [mv]   -> folder does not exist; cloning
    [mv]   -> clone OK
    [mv] copying files LEFT -> RIGHT (excluding .git/) ...
    [mv]   copied 142 files
    [mv] committing in https://github.com/owner/gitmap-v5 ...
    [mv]   commit a1b2c3d "gitmap mv from ./gitmap-v5"
    [mv] pushing https://github.com/owner/gitmap-v5 ...
    [mv]   push OK
    [mv] done
